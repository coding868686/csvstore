...
}(this, function moduleFactory()
{
	...
	function calcfn(){
	globalThis.flat = document.getElementById("flat_sel").value;
	globalThis.block = document.getElementById("block_sel").value;
	globalThis.floor = document.getElementById("floor_sel").value
...
Papa.parse(url,{
	...
	function doStuff(data){
		...
		var flat_index = data.findIndex(index_checking)
		console.log(flat_index)
		if (flat_index == -1){
		document.getElementById("output1").innerHTML = "Property not found!";
    	document.getElementById("output2").innerHTML = " ";
		} else{
		var result_price = data[flat_index].PRICE;
		var result_sfa = data[flat_index].SFA;
		document.getElementById("output1").innerHTML = "Price: HK$".concat(result_price,"m");
    	document.getElementById("output2").innerHTML = "SFA: ".concat(result_sfa," sq ft.");
}

	}
function index_checking(checkobj){
	return checkobj.BLOCK == block  && checkobj.FLOOR == floor && checkobj.FLAT == flat;
}